...
/**
 * Created with IntelliJ IDEA. User: peterdietz Date: 9/19/13 Time: 4:50 PM To
...
//    }
    @Override
    public String toString() {
        return "Item{" + "isArchived=" + isArchived + ", isWithdrawn=" + isWithdrawn + ", lastModified=" + lastModified + ", parentCollection=" + parentCollection + ", parentCollectionList=" + parentCollectionList + ", parentCommunityList=" + parentCommunityList + ", metadata=" + metadata + ", bitstreams=" + bitstreams + '}';
    }
}
