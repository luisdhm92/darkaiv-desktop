 ...
 * @author fenriquez
 */
public class IdentifierDetail extends Detail {

    private JLabel field;
    private JTextField textField;

    public IdentifierDetail(String key, String interfaceName, long doc_id, String value, int row) {
        ...
        try {
            ...
            document.addDocumentListener(new DocumentListener() {
                ...
                public void insertUpdate(DocumentEvent de) {
                    try {
                        Organizer.instance().updateIdentifier(getDoc_id(), getKey(), de.getDocument().getText(0, de.getDocument().getLength()));
                    } catch (BadLocationException ex) {
                        Logger.getLogger(IdentifierDetail.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
